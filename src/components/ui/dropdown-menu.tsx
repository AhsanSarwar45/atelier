...
/*
 * How a menu and its items are drawn, spelled once for every kind of menu: the
 * one a button drops down and the one a right-click opens (`context-menu.tsx`)
 * are the same list to the reader. Only the names of the primitive's own
 * measurements differ, so those stay with each menu.
 */
