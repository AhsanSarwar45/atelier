...
export function ProviderSettingsPanel({
  ...
  return (
    <div data-testid={`provider-settings-${brand}-${page}`}>
      {brand === 'claude' && page === 'defaults' && <p className="mb-4 text-sm text-t-secondary" data-testid="shared-output-style-link">Output styles are managed in Agent guidance for all providers. Claude’s native output-style setting does not apply to Atelier chats. <Button mode="link" underlined="solid" size="inherit" asChild><a href="/settings?section=library&guidance=output_style" onClick={event => {
      ...
      }}>Manage output styles</a></Button></p>}
      {refused && (
