...
export function SharedLibrary({ projectPath }: { projectPath?: string }) {
  ...
  return <div className="space-y-5" data-testid="shared-library">
    ...
    {answer && <>
      ...
      {draft ? <section className="min-w-0 space-y-5 border-t border-border/40 pt-5" aria-label="Library item editor" data-testid="library-editor">
        ...
        <div className="flex flex-wrap gap-2 border-t border-border/40 pt-4"><Button disabled={saving || !draft.id || !draft.name} onClick={() => {
