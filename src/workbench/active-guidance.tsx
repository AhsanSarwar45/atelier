...
export function ActiveGuidance({ snapshot }: { snapshot: GuidanceSnapshot }) {
  ...
  return <Popover>
    <PopoverTrigger asChild><Badge asChild appearance="outline" size="sm" shape="circle" className="hidden shrink-0 md:inline-flex"><Button variant="ghost" size="none" aria-label="Active guidance" data-testid="chat-shared-library"><BookOpen className="size-3" aria-hidden="true" /><span>Guidance</span></Button></Badge></PopoverTrigger>
