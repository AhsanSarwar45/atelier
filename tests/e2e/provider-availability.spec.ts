...
/**
 * Which agents a new chat offers requires both sides of the boundary: Atelier's
 * pinned ACP adapter and the provider executable installed by the user.
 *
 ...
 */
test('installed Claude and Codex providers behind bundled ACP adapters are selectable in a new chat', async ({ page, request }) => {
  test.skip(
