...
wire_kinds!(CommandKind {
    ...
    AgentFilesDelete => "agent-files.delete",
    ...
    ProfilesStanding => "profiles.standing",
    ProfileSignInStart => "profile.signin.start",
    ProfileSignInRead => "profile.signin.read",
    ProfileSignInPaste => "profile.signin.paste",
    ProfileSignInCancel => "profile.signin.cancel",
    ProviderAuthenticate => "provider.authenticate",
    ProviderLogout => "provider.logout",
    SessionStart => "session.start",
    PromptSend => "prompt.send",
    PromptHold => "prompt.hold",
    PromptDrop => "prompt.drop",
    PromptPush => "prompt.push",
...
wire_kinds!(EventKind {
    ...
    PromptHeld => "prompt.held",
    PromptReleased => "prompt.released",
